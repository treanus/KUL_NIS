...
matlabbatch{1}.cfg_basicio.file_dir.file_ops.file_fplist.filter = '###FMRIFILE0###';
matlabbatch{1}.cfg_basicio.file_dir.file_ops.file_fplist.rec = 'FPList';
matlabbatch{2}.cfg_basicio.file_dir.file_ops.file_fplist.dir = {'###FMRIDIR###'};
matlabbatch{2}.cfg_basicio.file_dir.file_ops.file_fplist.filter = '###FMRIFILE1###';
matlabbatch{2}.cfg_basicio.file_dir.file_ops.file_fplist.rec = 'FPList';
matlabbatch{3}.cfg_basicio.file_dir.file_ops.file_fplist.dir = {'###FMRIDIR###'};
matlabbatch{3}.cfg_basicio.file_dir.file_ops.file_fplist.filter = '###FMRIFILE2###';
...
matlabbatch{4}.spm.stats.fmri_spec.sess(1).scans(1) = cfg_dep('File Selector (Batch Mode): Selected Files (###FMRIFILE0###)', substruct('.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
...
matlabbatch{4}.spm.stats.fmri_spec.sess(1).multi_reg = {'###CONFOUNDSFILE0###'};
matlabbatch{4}.spm.stats.fmri_spec.sess(1).hpf = 128;
matlabbatch{4}.spm.stats.fmri_spec.sess(2).scans(1) = cfg_dep('File Selector (Batch Mode): Selected Files (###FMRIFILE1###)', substruct('.','val', '{}',{2}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
...
matlabbatch{4}.spm.stats.fmri_spec.sess(2).multi_reg = {'###CONFOUNDSFILE1###'};
matlabbatch{4}.spm.stats.fmri_spec.sess(2).hpf = 128;
matlabbatch{4}.spm.stats.fmri_spec.sess(3).scans(1) = cfg_dep('File Selector (Batch Mode): Selected Files (###FMRIFILE2###)', substruct('.','val', '{}',{3}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
...
matlabbatch{4}.spm.stats.fmri_spec.sess(3).multi_reg = {'###CONFOUNDSFILE2###'};
matlabbatch{4}.spm.stats.fmri_spec.sess(3).hpf = 128;
matlabbatch{4}.spm.stats.fmri_spec.fact = struct('name', {}, 'levels', {});
matlabbatch{4}.spm.stats.fmri_spec.bases.hrf.derivs = ###HRFDERIVS###;
