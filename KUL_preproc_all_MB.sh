...
function task_KUL_dwiprep {
    ...
    if [ ! -f  $dwiprep_file_to_check ]; then
        ...
        task_dwiprep_cmd=$(echo "KUL_dwiprep_MB.sh -p ${BIDS_participant} \         # MB changes 15-07-25
        ...
        if [ $make_pbs_files_instead_of_running -eq 1 ]; then
            ...
            task_command=$(echo "KUL_dwiprep_MB.sh -p \${BIDS_participant} \         # MB changes 15-07-25
